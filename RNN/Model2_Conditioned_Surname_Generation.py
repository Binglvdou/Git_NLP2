...
target_nationality = "Portuguese"
nationality_index = vectorizer.nationality_vocab.lookup_token(target_nationality)

print("\nSampled for {}: ".format(target_nationality))
sampled_indices = sample_from_model(model, vectorizer,
                                    nationalities=[nationality_index] * 5,
                                    temperature=0.7)
for sampled_surname in decode_samples(sampled_indices, vectorizer):
    print("-  " + sampled_surname)